...
- I dati live (nome/tel/rating) si caricano via `/api/places/details?place_id=X` a runtime, vivono solo in React state.
...
- Anthropic SDK (claude-haiku-4-5 per mail/audit)
...
- `src/app/api/places/details/route.ts` — proxy Places Details (chiave mai esposta al browser)
